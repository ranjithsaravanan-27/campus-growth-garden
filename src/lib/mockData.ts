...
export const mockTeam: Team = {
  ...
  treeHealth: 85,
  members: [
    { id: '1', name: 'Alex Chen', avatar: '🧑‍💻', githubUsername: 'alexchen', leetcodeUsername: 'alex_lc', commits: 34, problemsSolved: 18, points: 350, streak: 7, lastActive: '2h ago', isInactive: false },
    { id: '2', name: 'Priya Sharma', avatar: '👩‍💻', githubUsername: 'priyash', leetcodeUsername: 'priya_s', commits: 28, problemsSolved: 22, points: 360, streak: 12, lastActive: '30m ago', isInactive: false },
    { id: '3', name: 'Jordan Lee', avatar: '🧑‍🎓', githubUsername: 'jordanl', leetcodeUsername: 'jlee99', commits: 15, problemsSolved: 8, points: 155, streak: 3, lastActive: '1d ago', isInactive: false },
    { id: '4', name: 'Sam Rivera', avatar: '👨‍💻', githubUsername: 'samriv', leetcodeUsername: 'sam_r', commits: 5, problemsSolved: 2, points: 45, streak: 0, lastActive: '3d ago', isInactive: true },
  ],
